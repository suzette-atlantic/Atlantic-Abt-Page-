          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20 overflow-visible">
            <div className="space-y-6 overflow-visible">
              <div className="overflow-visible pb-1" style={{ maxWidth: '100%' }}>
                <h1 className="font-extrabold leading-[1.2] bg-gradient-to-r from-[#374A9E] to-[#3AC4DE] bg-clip-text text-transparent" style={{ fontSize: 'clamp(2.5rem, 5vw, 3.5rem)', maxWidth: '100%', overflow: 'visible', textAlign: 'left' }}>
