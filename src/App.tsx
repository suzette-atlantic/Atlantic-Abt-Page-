          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20 overflow-x-hidden">
            <div className="space-y-6 overflow-x-hidden">
              <div className="overflow-x-hidden pb-1">
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-[1.5] bg-gradient-to-r from-[#374A9E] to-[#3AC4DE] bg-clip-text text-transparent whitespace-nowrap" style={{ fontSize: 'clamp(2.5rem, 8vw, 4.5rem)' }}>
